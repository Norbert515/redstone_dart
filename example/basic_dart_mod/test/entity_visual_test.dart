/// Visual tests for entity rendering in basic_dart_mod.
///
...
Future<void> main() async {
  ...
  await clientGroup('Entity Visual Tests', () async {
    await testMinecraftClient('dart_zombie entity renders', (game) async {
      ...
      // Spawn the entity
      game.spawnEntity('basic_dart_mod:dart_zombie', spawnPos);
    ...
    await testMinecraftClient('dart_cow entity renders', (game) async {
      ...
      game.spawnEntity('basic_dart_mod:dart_cow', spawnPos);
    ...
    await testMinecraftClient('multiple entities render together', (game) async {
      ...
      // Spawn both entities
      game.spawnEntity('basic_dart_mod:dart_zombie', zombiePos);
      game.spawnEntity('basic_dart_mod:dart_cow', cowPos);
