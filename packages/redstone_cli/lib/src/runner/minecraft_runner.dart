      ...
      if (entity is File) {
        ...
        try {
          ...
          if (targetFile.existsSync() &&
              targetFile.lengthSync() == entity.lengthSync()) {
            continue; // Skip copying if size is the same, helps with locked files like dart_dll.dll
          }
          if (targetFile.existsSync()) {
          ...
          Logger.warning('Could not copy ${p.basename(entity.path)}: $e (might be locked by a running instance)');
        }
      }
    }
  }
